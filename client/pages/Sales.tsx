          ...
          {isMobile ? (
            ...
            >
              ...
              <DrawerContent className="max-h-[90vh]">
                ...
                <div className="px-4 pb-4 overflow-y-auto flex flex-col gap-6">
                  ...
                  {/* Payment */}
                  <div className={`order-3 lg:col-span-4 lg:col-start-9 grid grid-cols-1 sm:grid-cols-2 gap-4 ${showPaymentDetails ? "" : "hidden md:grid"}`}>
                    {!forBorrow && (
                      <div className="space-y-2">
                  ...
                  {/* Add Item Section */}
                  <div className="order-1 lg:col-span-8 rounded-lg border border-primary/20 bg-primary/[0.03] p-4 space-y-4">
                  ...
                  {newInvoice.items && newInvoice.items.length > 0 && (
                    <div className="order-4 lg:col-span-8 space-y-4">
                  ...
                  <div className={`order-5 lg:col-span-4 lg:col-start-9 space-y-2 ${showNotes ? "" : "hidden md:block"}`}>
            ...
            >
              ...
              <DialogContent className="w-[calc(100vw-2rem)] max-w-4xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="grid grid-cols-1 gap-5 px-1 sm:px-0 lg:grid-cols-12 lg:gap-6">
                  {/* Client Information */}
                  <div className="order-2 lg:col-span-4 lg:col-start-9 space-y-4">
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-3 rounded-lg bg-muted/40 p-3">
                      <input
                        type="radio"
                        id="existing-client"
